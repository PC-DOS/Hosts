...
Begin VB.Form frmIDisallow 
   ...
   End
End
Attribute VB_Name = "frmIDisallow"
...
MsgBox "目標IP不允許為空", vbCritical, "Error"
Text1.SetFocus
Exit Sub
End If
If Trim(Text2.Text) = "" Then
MsgBox "域名不允許為空", vbCritical, "Error"
Text1.SetFocus
Exit Sub
End If
Dim lpStrAdd As String
If Check2.Value = 0 Then
If Text3.Text = "" Then
lpStrAdd = Trim(Text1.Text) & "     " & Trim(Text2.Text)
Else
lpStrAdd = Trim(Text1.Text) & "     " & Trim(Text2.Text) & "     " & vbCrLf & "# " & Text3.Text
End If
Form1.List1.AddItem lpStrAdd
Else
lpStrAdd = Trim(Text1.Text) & "     " & Trim(Text2.Text)
If Text3.Text = "" Then
Form1.List1.AddItem lpStrAdd
